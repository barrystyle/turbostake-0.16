...
// turbostake
    // turbostake: money supply related block index fields
    int64_t nMint;
    int64_t nMoneySupply;

    // turbostake: proof-of-stake related block index fields
    unsigned int nFlags;  // turbostake: block index flags
    enum
    {
